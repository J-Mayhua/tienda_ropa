...
<<<<<<< HEAD
    <form action="/Tienda_ropa/publico/index.php?accion=cambiar_estado_pedido&id=<?php echo htmlspecialchars($pedido['id'], ENT_QUOTES, 'UTF-8'); ?>" method="POST">
        <?php echo csrf_field(); ?>
=======
    <form action="/Tienda_ropa/publico/index.php?accion=cambiar_estado_pedido&id=<?php echo $pedido['id']; ?>" method="POST" class="form-card">
...
<<<<<<< HEAD
        ...
        <a href="/Tienda_ropa/publico/index.php?accion=listar_pedidos" class="btn btn-cancelar">Cancelar</a>
=======
