        ...
        <div class="cuadricula-pie">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    <li><a href="/tienda_ropa/publico/index.php"><i class="fas fa-chevron-right"></i> Inicio</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right"></i> Catálogo</a></li>
                    <li><a href="#"><i class="fas fa-chevron-right"></i> Ofertas</a></li>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-contact">
                    <li><i class="fas fa-map-marker-alt"></i> Av. Moda 123, Lima, Perú</li>
